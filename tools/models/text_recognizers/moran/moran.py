...
import tools.models.text_recognizers.moran.tools.utils as utils
import tools.models.text_recognizers.moran.tools.dataset as dataset
from collections import OrderedDict
import cv2
from tools.models.text_recognizers.moran.models.moran import MORAN as moran_recognizer
from typing import AnyStr

from tools.Interfaces.text_recognizer_interface import ITextRecognizer


class MoranTextRecognizer(ITextRecognizer):
    def __init__(self):
        self.__result = None
        ...
        if torch.cuda.is_available():
            self.cuda_flag = True
            self.MORAN = moran_recognizer(1, len(self.alphabet.split(':')), 256, 32, 100, BidirDecoder=True,
                                          CUDA=self.cuda_flag)
