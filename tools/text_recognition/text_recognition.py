...
class TextRecognition(RecognitionUtils):
    # load models
    ...
    def get_recognition_result(self, image, boxes, number_of_components):
        ...
        for box in boxes:
            ...
            self.name += 1
            TextRecognition.run_recognition(roi, box, self.run_vino_recognition)
...
if __name__ == '__main__':
    ...
    try:
        TextRecognition.run_recognition(grey, None, text_recognition.run_vino_recognition)
